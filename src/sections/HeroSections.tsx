		...
		<section className="flex flex-col items-center mt-6 lg:mt-20 ">
			<h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
				...
				<span className="bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text">
					{" "}
					Startup, Web, Landing, Business.
				</span>
			</h1>
			<p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
				In a world where businesses need to stay ahead with cutting-edge software, our
				company offers bespoke solutions that are fast, reliable, and tailored to our
				clients exact needs.
			</p>
