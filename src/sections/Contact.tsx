...
const Contact = () => {
  return (
    <section
      id="contact"
      className="relative mt-20 border-t border-neutral-800"
    >
      <div className="my-20 flex flex-col items-center">
        ...
        <p className="mt-10 mb-20 text-lg items-center text-neutral-500 max-w-4xl">
          Have questions or need more information? Get in touch with us, and we
        ...
        <div className="flex flex-col lg:flex-row justify-around mx-4 gap-4">
          <div className="flex mb-8 lg:mb-0">
            ...
            <div>
              ...
              <p className="text-neutral-600">info@antuanlabs.com</p>
            </div>
          </div>
          <div className="flex mb-8 lg:mb-0">
